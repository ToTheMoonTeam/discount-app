  ...
  <div class="form">
    <div class="card-form">
      ...
      <v-form @submit.prevent="formSubmit" ref="form" v-model="valid" lazy-validation>
        ...
        <v-text-field color="amber accent-4" label="Номер карты ИдеалТрейд" v-model="id" />
        ...
        <v-btn class="mt-8" color="amber accent-3" type="submit" :disabled="!valid" @click="validate">
          Отправить
        </v-btn>
      </v-form>
    </div>
